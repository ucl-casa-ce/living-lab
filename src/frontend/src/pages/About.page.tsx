                    ...
                    <>
                        ...
                        <Stack>
                            <Paper withBorder p="md" radius="md">
                                ...
                                <Text mt="sm">
                                    Through real-time data fusion and 3D modeling, Living Lab enables a seamless onboarding experience for innovators and fosters transparent lifecycle tracking of technological solutions, from prototype to deployment.
                                </Text>
                            </Paper>
                            ...
                            <Paper withBorder p="md" radius="md">
                                ...
                                <Text mt="sm">
                                    Living Lab places community participation at the heart of its mission. By facilitating co-design processes and digital literacy programs, it ensures the voices of East London's diverse communities shape the evolution of the park’s innovation environment.
                                </Text>
                                <Text mt="sm">
                            ...
                            <Paper withBorder p="md" radius="md">
                                ...
                                <Text mt="sm">
                                    Living Lab is a platform for sustainable action. It leverages environmental data in real-time—on energy, biodiversity, water, and climate—to guide conservation, circular economy models, and resilient urban design.
                                </Text>
                                <Text mt="sm">
                        ...
                        <Paper withBorder p="md" radius="md">
                            ...
                            <Text mt="sm">
                                Through carefully curated architecture and governance models, Living Lab balances technical excellence with social and environmental responsibility.
                            </Text>
                        </Paper>
                        ...
                        <Paper withBorder p="md" radius="md">
                            ...
                            <Text mt="sm" c="dimmed">
                                © 2025 Living Lab | Powered by the Connected Environments Lab at UCL.
                            </Text>
                        </Paper>
                    </>
                )
